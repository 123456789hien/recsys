...
class PageRankApp {
    ...
    async loadDefaultData() {
        try {
            ...
            this.edges = data.map(d => ({ source: d.source, target: d.target }));

            this.graphRenderer.renderGraph(this.nodes, this.edges); // ✅ FIX: call method from graphRenderer
            this.populateTable();
        } catch (err) {
    ...
    populateTable() {
        ...
        // ✅ Sort table by descending PageRank
