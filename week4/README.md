...
- _Goal_: Build an in-browser Two-Tower model:
...
**UX Requirements**
- _Buttons_: “Load Data”, “Train”, “Test”.
- _Training_: show live loss chart and epoch progress; after training, render 2D projection (PCA or t-SNE via numeric approximation) of a sample of item embeddings.
- _Test_: 
...
_**c) two-tower.js**_
- _Implement a minimal Two-Tower in TF.js_:
    - Class TwoTowerModel:
