// data.js
// Responsible for loading and parsing MovieLens data (u.item and u.data) from data/ folder
    ...
    try {
        ...
        if (resultElement) {
            resultElement.innerText =
                "Error loading data. Please make sure data/u.item and data/u.data exist."
        }
        throw error
    }
}
