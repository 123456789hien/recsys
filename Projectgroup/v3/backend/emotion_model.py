...
def download_from_drive(file_id, output_path):
    url = f'https://drive.google.com/drive/folders/1dFhuyxH3-qMA14zXWWe4XLJskRZKlInf?usp=drive_link'
    gdown.download(url, output_path, quiet=False)

# Tải mô hình CNN
def download_model():
    model_file_id = 'https://drive.google.com/file/d/1HrSZ8jKcrnMmHYnk9en_CXWxYa0av20T/view?usp=sharing'  # Thay bằng ID thực tế
...
def download_label_encoder():
    encoder_file_id = 'https://drive.google.com/file/d/1RuZ-9ZRCYDSf-GnA-wkRVgwZaCwqcn5k/view?usp=sharing'  # Thay bằng ID thực tế
