...
async function train() {
    ...
    model = new TwoTowerModel(numUsers,numItems,embeddingDim,true);
    basicModel = new TwoTowerModel(numUsers,numItems,embeddingDim,false);
    let losses = [];
